...
# Bug #506124 https://bugs.gentoo.org/show_bug.cgi?id=506124
# changes all references of "#include freetype/ftoutln.h>", "#include <freetype/ttnameid.h>" to "#include FT_OUTLINE_H, #include FT_TRUETYPE_IDS_H"
# in miscsplashutils-0.1.8/fbtruetype/ttf.c:
		cd "${SM}"
		epatch "${FILESDIR}/splashutils-1.5.4.4-freetype251.patch"
# and in splashutils-1.5.4.4/src/ttf.[h,c]:
		cd "${S}"
...
# Bug #499654 https://bugs.gentoo.org/show_bug.cgi?id=499654
