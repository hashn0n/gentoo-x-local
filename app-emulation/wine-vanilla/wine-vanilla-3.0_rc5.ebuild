...
pkg_setup() {
	...
	MY_DOCDIR="${EPREFIX}/usr/share/doc/${MY_PF}"
...
pkg_postinst() {
	eselect wine register ${P/_/-}
	if [[ ${PN} == "wine-vanilla" ]]; then
		eselect wine register --vanilla ${P/_/-} || die
	fi
...
pkg_prerm() {
	eselect wine deregister ${P/_/-}
	if [[ ${PN} == "wine-vanilla" ]]; then
		eselect wine deregister --vanilla ${P/_/-} || die
	fi
